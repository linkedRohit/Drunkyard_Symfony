...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/html/FirstSymfonyProject/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $a = $this->get('templating.loader');
        $b = new \Assetic\Cache\ConfigCache('/var/www/html/FirstSymfonyProject/app/cache/prod/assetic/config');
    ...
    {
        require_once '/var/www/html/FirstSymfonyProject/app/cache/prod/jms_diextra/doctrine/EntityManager_567671b4972dd.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_d4381753bccfdd0defa1dae091686392');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_d4381753bccfdd0defa1dae091686392');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_d4381753bccfdd0defa1dae091686392');
        ...
        $d->setProxyDir('/var/www/html/FirstSymfonyProject/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager567671b4972dd_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/var/www/html/FirstSymfonyProject/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/var/www/html/FirstSymfonyProject/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/var/www/html/FirstSymfonyProject/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/var/www/html/FirstSymfonyProject/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/html/FirstSymfonyProject/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/var/www/html/FirstSymfonyProject/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/var/www/html/FirstSymfonyProject/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/html/FirstSymfonyProject/app/../web', false);
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/var/www/html/FirstSymfonyProject/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/html/FirstSymfonyProject/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/html/FirstSymfonyProject/app/cache/prod',
            ...
            'session.save_path' => '/var/www/html/FirstSymfonyProject/app/cache/prod/sessions',
            ...
            'router.resource' => '/var/www/html/FirstSymfonyProject/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/html/FirstSymfonyProject/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/var/www/html/FirstSymfonyProject/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/var/www/html/FirstSymfonyProject/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/html/FirstSymfonyProject/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/var/www/html/FirstSymfonyProject/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/var/www/html/FirstSymfonyProject/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(
            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/var/www/html/FirstSymfonyProject/app/cache/prod/jms_diextra/doctrine/EntityManager_567671b4972dd.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager567671b4972dd_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/var/www/html/FirstSymfonyProject/app/cache/prod/jms_security',
            ...
            'smarty.options' => array(
                ...
                'cache_dir' => '/var/www/html/FirstSymfonyProject/app/cache/prod/smarty/cache',
                'compile_dir' => '/var/www/html/FirstSymfonyProject/app/cache/prod/smarty/templates_c',
