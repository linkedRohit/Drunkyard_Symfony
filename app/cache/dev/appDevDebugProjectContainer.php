...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/html/FirstSymfonyProject/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $b = new \Assetic\Cache\ConfigCache('/var/www/html/FirstSymfonyProject/app/cache/dev/assetic/config');

        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), $b, true), 'smarty' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \NoiseLabs\Bundle\SmartyBundle\Assetic\SmartyFormulaLoader($this->get('templating.engine.smarty')), $b, true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', '/var/www/html/FirstSymfonyProject/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', '/var/www/html/FirstSymfonyProject/app/Resources/views', '/\\.[^.]+\\.smarty$/'), 'smarty');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/var/www/html/FirstSymfonyProject/app/Resources');
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager5676a003ba098_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager5676a003ba098_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/var/www/html/FirstSymfonyProject/app/cache/dev/jms_diextra/doctrine/EntityManager_5676a003ba098.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_e80015d407603043898abb169b215f75');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_e80015d407603043898abb169b215f75');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_e80015d407603043898abb169b215f75');
        ...
        $d->setProxyDir('/var/www/html/FirstSymfonyProject/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager5676a003ba098_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/html/FirstSymfonyProject/app/Resources');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/var/www/html/FirstSymfonyProject/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/var/www/html/FirstSymfonyProject/app/logs/dev.log', 100, true);
    }
    ...
    /**
     * Gets the 'monolog.logger.smartybundle' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/var/www/html/FirstSymfonyProject/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/var/www/html/FirstSymfonyProject/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/var/www/html/FirstSymfonyProject/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/var/www/html/FirstSymfonyProject/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/html/FirstSymfonyProject/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/var/www/html/FirstSymfonyProject/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/html/FirstSymfonyProject/app/cache/dev/sessions');
    }
    ...
    /**
     * Gets the 'smarty.extension.assetic.dynamic' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return NoiseLabs\Bundle\SmartyBundle\Extension\DynamicAsseticExtension A NoiseLabs\Bundle\SmartyBundle\Extension\DynamicAsseticExtension instance.
     */
    ...
    /**
     * Gets the 'smarty.templating.finder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return NoiseLabs\Bundle\SmartyBundle\CacheWarmer\SmartyTemplateFinder A NoiseLabs\Bundle\SmartyBundle\CacheWarmer\SmartyTemplateFinder instance.
     */
    protected function getSmarty_Templating_FinderService()
    {
        return $this->services['smarty.templating.finder'] = new \NoiseLabs\Bundle\SmartyBundle\CacheWarmer\SmartyTemplateFinder($this->get('kernel'), $this->get('templating.filename_parser'), '/var/www/html/FirstSymfonyProject/app/Resources');
    }
    ...
    /**
     * Gets the 'templating.engine.smarty' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return NoiseLabs\Bundle\SmartyBundle\SmartyEngine A NoiseLabs\Bundle\SmartyBundle\SmartyEngine instance.
     */
    protected function getTemplating_Engine_SmartyService()
    {
        $this->services['templating.engine.smarty'] = $instance = new \NoiseLabs\Bundle\SmartyBundle\SmartyEngine($this->get('smarty'), $this, $this->get('templating.name_parser'), $this->get('templating.loader'), array('escape_html' => true, 'error_reporting' => 'error_reporting() & ~E_NOTICE', 'cache_dir' => '/var/www/html/FirstSymfonyProject/app/cache/dev/smarty/cache', 'compile_dir' => '/var/www/html/FirstSymfonyProject/app/cache/dev/smarty/templates_c', 'config_dir' => '/var/www/html/FirstSymfonyProject/app/config/smarty', 'default_resource_type' => 'file', 'template_dir' => '/var/www/html/FirstSymfonyProject/app/Resources/views', 'use_include_path' => false, 'use_sub_dirs' => true), $this->get('templating.globals', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.smartybundle', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/var/www/html/FirstSymfonyProject/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/var/www/html/FirstSymfonyProject/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/var/www/html/FirstSymfonyProject/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/var/www/html/FirstSymfonyProject/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/html/FirstSymfonyProject/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/var/www/html/FirstSymfonyProject/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/var/www/html/FirstSymfonyProject/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/var/www/html/FirstSymfonyProject/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/var/www/html/FirstSymfonyProject/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/var/www/html/FirstSymfonyProject/vendor/noiselabs/smarty-bundle/NoiseLabs/Bundle/SmartyBundle/Resources/views', 'Smarty');
        $instance->addPath('/var/www/html/FirstSymfonyProject/src/Social/DrunkenBundle/Resources/views', 'SocialDrunken');
        $instance->addPath('/var/www/html/FirstSymfonyProject/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/var/www/html/FirstSymfonyProject/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/var/www/html/FirstSymfonyProject/app/Resources/views');
        $instance->addPath('/var/www/html/FirstSymfonyProject/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/html/FirstSymfonyProject/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/var/www/html/FirstSymfonyProject/app/cache/dev/assetic/assets');
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/var/www/html/FirstSymfonyProject/app/cache/dev/jms_security', true));
    ...
    /**
     * Gets the 'smarty.extension.routing' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return NoiseLabs\Bundle\SmartyBundle\Extension\RoutingExtension A NoiseLabs\Bundle\SmartyBundle\Extension\RoutingExtension instance.
     */
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/html/FirstSymfonyProject/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/var/www/html/FirstSymfonyProject/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/html/FirstSymfonyProject/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/html/FirstSymfonyProject/app/cache/dev',
            'kernel.logs_dir' => '/var/www/html/FirstSymfonyProject/app/logs',
            'kernel.bundles' => array(
                ...
                'SocialDrunkenBundle' => 'Social\\DrunkenBundle\\SocialDrunkenBundle',
            ...
            'debug.container.dump' => '/var/www/html/FirstSymfonyProject/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/var/www/html/FirstSymfonyProject/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/var/www/html/FirstSymfonyProject/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/var/www/html/FirstSymfonyProject/app/cache/dev/profiler',
            ...
            'router.resource' => '/var/www/html/FirstSymfonyProject/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/html/FirstSymfonyProject/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/var/www/html/FirstSymfonyProject/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/var/www/html/FirstSymfonyProject/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/var/www/html/FirstSymfonyProject/app/../web',
            'assetic.write_to' => '/var/www/html/FirstSymfonyProject/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/html/FirstSymfonyProject/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/var/www/html/FirstSymfonyProject/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/var/www/html/FirstSymfonyProject/app/cache/dev/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/var/www/html/FirstSymfonyProject/app/cache/dev/jms_diextra/doctrine/EntityManager_5676a003ba098.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5676a003ba098_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/var/www/html/FirstSymfonyProject/app/cache/dev/jms_security',
            ...
            'smarty.options' => array(
                ...
                'cache_dir' => '/var/www/html/FirstSymfonyProject/app/cache/dev/smarty/cache',
                'compile_dir' => '/var/www/html/FirstSymfonyProject/app/cache/dev/smarty/templates_c',
                'config_dir' => '/var/www/html/FirstSymfonyProject/app/config/smarty',
                'default_resource_type' => 'file',
                'template_dir' => '/var/www/html/FirstSymfonyProject/app/Resources/views',
